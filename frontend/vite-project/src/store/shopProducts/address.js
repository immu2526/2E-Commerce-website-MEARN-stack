  ...
  async ({ userId, form }, { rejectWithValue }) => {
    try {
      const { data } = await axios.post(
        `https://twoe-commerce-website-mearn-stack-backend.onrender.com/api/shop/product/address/${userId}/new`,
        form
      );
      console.log(data);
      return data;
  ...
  async (userId, { rejectWithValue }) => {
    try {
      const { data } = await axios.get(
        `https://twoe-commerce-website-mearn-stack-backend.onrender.com/api/shop/product/address/${userId}`
      );
      return data;
    } catch (err) {
      return rejectWithValue(err.response.data);
  ...
  async ({ productId, userId }, { rejectWithValue }) => {
    try {
      const { data } = await axios.delete(
        `https://twoe-commerce-website-mearn-stack-backend.onrender.com/api/shop/product/address/${userId}/${productId}`
      );
      console.log(data);
      return data;
    } catch (err) {
...
export const featchSingleAddress = createAsyncThunk(
  ...
  async (addressId, { rejectWithValue }) => {
    try {
      const { data } = await axios.get(
        `https://twoe-commerce-website-mearn-stack-backend.onrender.com/api/shop/product/address/${addressId}/edit`
      );
      console.log(data);
      return data;
    } catch (err) {
  ...
  async ({ addressId, userId, form }, { rejectWithValue }) => {
    try {
      const { data } = await axios.put(
        `https://twoe-commerce-website-mearn-stack-backend.onrender.com/api/shop/product/address/${addressId}/${userId}/update`,
        form
      );
      console.log(data);
      return data;
