  ...
  async ({ data, id }, { rejectWithValue }) => {
    try {
      const review = await axios.post(
        `https://twoe-commerce-website-mearn-stack-backend.onrender.com/api/shop/product/review/${id}/review`,
        data,
        {
  ...
  async (id, { rejectWithValue }) => {
    try {
      const { data } = await axios.get(
        `https://twoe-commerce-website-mearn-stack-backend.onrender.com/api/shop/product/review/${id}`
      );
      console.log(data);
      return data;
    } catch (err) {
